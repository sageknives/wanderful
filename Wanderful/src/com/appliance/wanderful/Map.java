	...
	private class navClickListeners implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			if (homeBtn.getId() == v.getId())
				startActivity(new Intent(Map.this, SearchEvent.class));
			if (mainScheduleBtn.getId() == v.getId())
				startActivity(new Intent(Map.this, MainSchedule.class));
			if (myScheduleBtn.getId() == v.getId())
				startActivity(new Intent(Map.this, MySchedule.class));
			if (hashFeedBtn.getId() == v.getId())
				startActivity(new Intent(Map.this, HashFeed.class));
