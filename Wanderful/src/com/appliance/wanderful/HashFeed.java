...
public class HashFeed extends BaseActivity {
	...
	String instagramURL = "https://api.instagram.com/v1/tags/search?q=" + HashSearch;
	final String INSTAGRAMAPIKEY = "b64992c95c2f4631b09e2b06c2f3ab0d";
	final String INSTAGRAMAPISECRET = "bfc94fe31f7c4f73ab35c0da381aac5f";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		*/
		...
		protected class GetInstagramBearerTokenTask extends AsyncTask<Void, Void, String> {
			ProgressDialog progressDialog;
			...
			protected String doInBackground(Void... params) {
				...
				try {
					...
					String apiString = INSTAGRAMAPIKEY + ":" + INSTAGRAMAPISECRET;
					String authorization = "Basic " + Base64.encodeToString(apiString.getBytes(), Base64.NO_WRAP);
	    	...
	    	public void onPreExecute() {
	    		progressDialog = new ProgressDialog(HashFeed.this);
	    		progressDialog.setMessage("Connecting to Instagram..");
	    		progressDialog.setCancelable(false);
	    		progressDialog.setIndeterminate(true);
	    		progressDialog.show();
	    	}
		...
		protected class GetInstagramFeedTask extends AsyncTask<String, Void, String> {
			ProgressDialog progressDialog;
	    	...
	    	public void onPreExecute() {
	    		progressDialog = new ProgressDialog(HashFeed.this);
	    		progressDialog.setMessage("Getting grams?..");
	    		progressDialog.setCancelable(false);
	    		progressDialog.setIndeterminate(true);
	    		progressDialog.show();
	    	}
			...
			protected void onPostExecute(String jsonText){
				...
				try {
					//txt.setText(jsonText);
					Log.d("twitter","in instagram set text");
					mJsonObject = new JSONObject(jsonText);
					Log.d("twitter","in twitter set json text to object");
					JSONArray tweetArray = mJsonObject.getJSONArray("statuses");
					Log.d("twitter","in twitter set json statuses, size=" + tweetArray.length());
